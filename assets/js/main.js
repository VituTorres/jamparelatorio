...
import { addService, delSvc, addDriver, rmDrv, changePw, genReport, registerSingleCab, registerBatchCabs, removeCab, renderCabList, stab, updateDriverName, updateDriverPassword, exportPDF } from './views/admin.js';
